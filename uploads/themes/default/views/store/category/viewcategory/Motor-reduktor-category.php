...
?>
    ...
    array("code" => "info-blok-dlya-reduktory-motor-reduktory-verhnyaya-chast"));
?> 
	</div>
    ...
    font-weight: bold;">
						<a style="color:#366B81;" href="<?= " /store/reduktory-motor-reduktory/".$item->slug ?>">
							<?=$item->name; ?>
							</a>
					</h2>
					<p>
				...
				<div class="col-lg-3 hidden-xs" style="background-color:#49A9C2; height:inherit; border-left:5px solid white;">
