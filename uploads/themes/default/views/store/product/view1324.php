				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-4 fullhd">
						...
						<div class="button-block">
							...
							<br>
							<button type="button" class="button-style button-mobile " data-toggle="modal" data-target="#myModal2" onclick="$('#mobile-form-order').toggleClass('mobile-form-order-now');"> Оставить заявку <img src="http://tali.ru/wp-content/uploads/2015/01/phone_2190-e1422511546618.png"> </button>
							<div  class="visible-xs" style="width:100%;">
							<hr>
							<form id="mobile-form-order">
							<label for="emailmobile"> Ваш Email или телефон </label>
							<input class="form-control" id="emailmobile" type="text">
							<label for="succmobile">Ваше сообщение </label>
								<textarea id="succmobile" class="form-control"> </textarea>
					...
					<div class="col-lg-9 col-md-9 col-sm-8">
						...
						<div id="block-description" class="description-block hidden-xs">
							<p>
							<?php 
                                foreach ($product->getAttributeGroups() as $name => $items)
                                {
                                    $groupName = $name;
                                }
                                ?>
								<h1> <?=$groupName; ?> <?= CHtml::encode($product->name); ?></h1> </p>
							<p>
								<?= $product->description; ?>
							</p>
						</div>
