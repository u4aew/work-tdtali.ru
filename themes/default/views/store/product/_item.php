...
/* @var Product $data */
?>
<?php if ($data->category->parent_id == 37) : ?>
            ...
            <div class="form-order-mobile" style="display:none;">
                <form class="mobileneedMailForm" method="post">
                    <fieldset class="form-group">
                        ...
                        <button onclick="yaCounter4512622.reachGoal('paym'); return true;" class="btn btn-success" style="width:100%; height:50px; margin-top:15px" type="submit">
                            Отправить
                        </button>
                    </fieldset>
                </form>
